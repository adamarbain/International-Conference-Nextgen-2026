...
export const speakers: Speaker[] = [
  {
    ...
    topic: "Reimagining Business in the Age of NextGen IT, A Governance and Sustainability Perspective",
    initials: "NI",
    color: "#1a2e5a",
    image: "/ismawati.jpg",
  },
  {
    id: "speaker-2",
    name: "Prof. Ts. Dr. Nor Badrul Anuar bin Juma’at",
    title: "Professor",
    role: "Keynote Speaker 2",
    institution: "Faculty of Computer Science and Information Technology, UM",
    keynoteNumber: 2,
    bio: "Prof. Ts. Dr. Nor Badrul Anuar bin Juma’at is a distinguished academic leader and researcher with a profound track record in institutional governance, digital transformation, and cybersecurity.",
    topic: "The Agentic Shift\nWhen AI Stops Answering and Starts Working - And Why The Only Limit Left is Our Imagination",
    initials: "BA",
    color: "#374151",
    image: "/badrul.png",
  },
  {
    ...
    institution: "Faculty of Business and Economics, UM",
    keynoteNumber: 3,
    bio: "Prof. Dr. Yusniza is a distinguished professor with deep expertise in digital transformation and sustainable business practices.",
  ...
  },
  {
    ...
    role: "Keynote Speaker 4",
    institution: "Ancom Nylex Berhad",
    keynoteNumber: 4,
    bio: "Datuk Lee Cheun Wei is the Chief Executive Officer of Ancom Nylex Berhad, with extensive leadership experience in finance, corporate strategy, and business transformation.",
...
export const committeeGroups: CommitteeGroup[] = [
  {
    ...
    members: [
      ...
      },
      {
        id: "p3",
        name: "Prof. Dr. Yusniza binti Kamarulzaman",
        role: "Faculty of Business & Economics",
        institution: "Universiti Malaya",
        // image: "/Yusniza.png",
      },
      {
  ...
  // },
  {
    ...
    members: [
      ...
      {
        id: "ac2",
        name: "Mas Idayu Sabri",
        role: "Promotion Committee",
        institution: "Universiti Malaya",
      },
      {
        id: "ac3",
        name: "Prof. Dr. Mohd Yamani Idna Idris",
        role: "Promotion Committee",
        institution: "Universiti Malaya",
      },
      {
  ...
  //   members: [
  //     { id: "s1", name: "YANG YANG", role: "", institution: "CUZ, CHINA" },
  //     { id: "s2", name: "Muktar Yahuza", role: "", institution: "Nigeria" },
  //     {
  //       id: "s3",
  //       name: "MOHAMMED AHMED MOHAMMED ALMAHNI",
  //       role: "",
  //       institution: "Imam Mohammad Ibn Saud University, KSA",
  //     },
  //     { id: "s4", name: "NOR BAKIHA WARIF", role: "", institution: "UTHM, MALAYSIA" },
  //     { id: "s5", name: "Belal Sudqi Khater", role: "", institution: "Amman Arab University, JORDAN" },
  //     { id: "s6", name: "ALMUTAIRI NASER SULIMAN S", role: "", institution: "University of Bisha, KSA" },
  //     { id: "s7", name: "Omar Adil Mahdi", role: "", institution: "University of Baghdad, Iraq" },
  //     {
  //       id: "s8",
  ...
  //     },
  //     { id: "s9", name: "Noor Hazlina Abdul Mutalib", role: "", institution: "UNIKL, Malaysia" },
  //     { id: "s10", name: "Mohamad Nizam Ayub", role: "", institution: "Universiti Malaya, Malaysia" },
  //     { id: "s11", name: "Hannyzura Pal@Affal", role: "", institution: "Universiti Malaya, Malaysia" },
  //     { id: "s12", name: "Mas Idayu Sabri", role: "", institution: "Universiti Malaya, Malaysia" },
  //     { id: "s13", name: "Roziana Ramli", role: "", institution: "Northumbria University, UK" },
  //     { id: "s14", name: "Nornazlita Hussin", role: "", institution: "Universiti Malaya, Malaysia" },
  //   ],
  // },
  {
    id: "finance",
    ...
    members: [
      {
        id: "op1",
        name: "Prof. Dr. Siti Hafizah AB Hamid",
        role: "Head of Finance Committee",
        institution: "Universiti Malaya",
      },
      {
        id: "op2",
        name: "Dr Lau Chia Fong",
  ...
  },
  {
    ...
    members: [
      {
        id: "log1",
        name: "Mohamad Nizam Ayub",
        role: "Head of Publicity Committee",
        institution: "Universiti Malaya",
      },
      {
        id: "log2",
        name: "Nornazlita Hussin",
        role: "Publicity Committee",
        institution: "Universiti Malaya",
      },
      {
        id: "log3",
        name: "Hannyzura Pal@Affal",
        role: "Publicity Committee",
        institution: "Universiti Malaya",
      },
      {
        id: "log4",
        name: "Zulkefle Kassim",
        role: "Publicity Committee",
        institution: "Universiti Malaya",
      },
      {
        id: "log5",
        name: "Wan Mohd Hasanul Isyraf Wan Yusoff",
        role: "Publicity Committee",
        institution: "Universiti Malaya",
      },
    ],
    ...
    members: [
      {
        id: "admin1",
        name: "Balqis Bahari",
        role: "Head of Administration Committee",
        institution: "Universiti Malaya",
      },
      {
        id: "admin2",
        name: "Nurfatehah M. Zahir",
        role: "Administration Committee",
        institution: "Universiti Malaya",
      },
      {
        id: "admin3",
        name: "Zunaida Alwadood",
        role: "Administration Committee",
        institution: "Universiti Malaya",
      },
      {
  ...
  // },
  {
    ...
    members: [
      ...
      },
      {
        ...
        name: "Yang Yang",
        role: "International Committee",
        institution: "China University of Zhejiang (CUZ), China",
      },
      {
        id: "int3",
        name: "Muktar Yahuza",
      ...
      },
      {
        ...
        name: "Mohammed Ahmed Mohammed Almahni",
        role: "International Committee",
        institution: "Imam Mohammad Ibn Saud University, UAE",
      },
      {
        id: "int5",
        name: "Nor Bakiha Warif",
        role: "International Committee",
        institution: "UTHM, Malaysia",
      },
      {
        id: "int6",
        name: "Belal Sudqi Khater",
        role: "International Committee",
        institution: "Amman Arab University, Jordan",
      },
      {
        id: "int7",
        name: "Almutairi Naser Suliman S",
        role: "International Committee",
        institution: "University of Bisha, UAE",
      },
      {
        id: "int8",
        name: "Omar Adil Mahdi",
        role: "International Committee",
        institution: "University of Baghdad, Iraq",
      },
      {
        id: "int9",
        name: "Dr. Mehdi Hussain",
      ...
      {
        id: "int10",
        name: "Noor Hazlina Abdul Mutalib",
        role: "International Committee",
        institution: "UNIKL, Malaysia",
      },
    ],
  },
];
